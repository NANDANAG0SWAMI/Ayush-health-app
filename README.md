...
*(Note: To add images, place your screenshot files in an `assets` folder within your project repository, and update the file paths below. Alternatively, if viewing this on GitHub, you can drag and drop your images directly into the editor to generate the links automatically.)*

### 🏠 Home Dashboard
*Daily vitals, wellness score, and curated health stories.*
![Home Screen - Top View](./assets/home-image-1.png)
![Home Screen - Scroll View](./assets/home-image-2.png)

### 📍 Interactive Body Map
*Tap-to-select regions and symptom logging.*
![Body Map - Main View](./assets/bodymap-image-1.png)
![Body Map - Symptom Modal](./assets/bodymap-image-2.png)

### 🤖 AYUSH Assistant
*AI-powered holistic health companion.*
![Chatbot - Greeting](./assets/chat-image-1.png)
![Chatbot - Conversation](./assets/chat-image-2.png)

### 👨‍⚕️ Doctor Consultations
*Connect with certified AYUSH practitioners.*
![Doctors - List View](./assets/doctor-image-1.png)
